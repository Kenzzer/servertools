...
#define DECLARE_INTENTION_INTERFACE( Actor )	\
	...
	private:									\
		...
		Actor* m_me;							\
												...
												\
	public: virtual IIntention *GetIntentionInterface( void ) const override { return m_intention; }	\
...
#define IMPLEMENT_INTENTION_INTERFACE( Actor, InitialAction ) \
	Actor::Actor##Intention::Actor##Intention( Actor *me ) : IIntention( me->MyNextBotPointer() ), m_me(me)	{ m_behavior = new Behavior< Actor >( new InitialAction ); }	\
	...
	void Actor::Actor##Intention::Update( void ) { m_behavior->Update( m_me, GetUpdateInterval() ); }
