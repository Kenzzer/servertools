...
public:
	...
	static VCall<IBody*> vGetBodyInterface;
	static VCall<IIntention*> vGetIntentionInterface;
	static VCall<ILocomotion*> vGetLocomotionInterface;
	static VCall<void, const char*> vDisplayDebugText;
private:
