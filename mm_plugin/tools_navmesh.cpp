...
void CToolsNavMesh::Load()
{
	...
	META_CONPRINTF("Parsed %d nav areas.\n", GetNavAreaCount());
}
...
CNavArea* CToolsNavMesh::GetNearestNavArea( CBaseEntity *pEntity, int nFlags, float maxDist ) const
{
	VPROF( "CToolsNavMesh::GetNearestNavArea [ent]" );
